...
def main():
    ...
    # 注册前置机地址
    api.registerFront("tcp://180.169.101.177:41213")
    ...
    # 登陆
    loginReq = dict()  # 创建一个空字典
    loginReq['UserID'] = '108800629'  # 参数作为字典键值的方式传入
    loginReq['Password'] = '142101'  # 键名和C++中的结构体成员名对应
    loginReq['BrokerID'] = '66666'
    reqid += 1  # 请求数必须保持唯一性
    ...
    # 订阅合约，测试通过
    i = api.subscribeMarketData('rb1801')

    # 退订合约，测试通过
    # i = api.unSubscribeMarketData('rb1710')
